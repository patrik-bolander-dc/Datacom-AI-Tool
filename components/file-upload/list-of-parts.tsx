...
import { cn, roundDp } from "@/lib/utils";
        ...
        <div className="">
            <ul className="text-xs">
                  {MOCK_carDamageData.damagedParts.map((item, index) => {
                    ...
                    console.log(carPartColorMap[item.Name]);
                    console.log(cn('rounded py-0.5 px-4 text-white', carPartColorMap[item.Name]));

                    return (<li key={index} className='py-2 space-x-2'>
